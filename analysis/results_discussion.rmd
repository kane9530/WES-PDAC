...
Here, we discuss the SNP/INDEL mutational landscape for our samples. The oncoplot shown in Figure \@ref(fig:oncoplotCosmic) shows the
...
We find that the majority of mutations identified (2964) are unique to each patient, with only 1 gene shared across 15 (KRAS),  12 (TP53) and 11 (OR8U1) patients (Figure \@ref(fig:numMut)). 3 (CHIT1, MUC5AC and TTN) genes are shared across 8 patients, 3 () This suggests that the mutational landscape is highly heterogeneous, with a few conserved driver genes tshared across distinct individuals.
...
We incorporated the CNA results into the oncoplot and display them in this report. Note that CNA results are absent from 2 patients, PCA80 and PCA35 as they did not have matched blood samples for accurate copy number profile identification with ASCAT. Two oncoplots are shown,
